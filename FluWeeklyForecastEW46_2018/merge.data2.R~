...
#### rename output files
system("cp ./output/all.csv ./EW45-UCSF1-2018-11-19.csv")
system("cp ./output/all.ca.csv ./EW45-UCSF1-CA-2018-11-19.csv")
system("cp ./output/all.state.csv ./EW45-UCSF1-States-2018-11-19.csv")


system("wc -l  EW45-UCSF1-2018-11-19.csv")
system("wc -l  EW45-UCSF1-CA-2018-11-19.csv")
system("wc -l  EW45-UCSF1-States-2018-11-19.csv")
system("cp  EW45-UCSF1-2018-11-19.csv EW45-UCSF1-CA-2018-11-19.csv EW45-UCSF1-States-2018-11-19.csv forecast1-4wk.png ./submit")
