...
#### rename output files
system("cp ./output/all.csv ./EW03-UCSF1-2019-01-28.csv")
system("cp ./output/all.ca.csv ./EW03-UCSF1-CA-2019-01-28.csv")
system("cp ./output/all.state.csv ./EW03-UCSF1-States-2019-01-28.csv")


system("wc -l  EW03-UCSF1-2019-01-28.csv")
system("wc -l  EW03-UCSF1-CA-2019-01-28.csv")
system("wc -l  EW03-UCSF1-States-2019-01-28.csv")
system("cp  EW03-UCSF1-2019-01-28.csv EW03-UCSF1-CA-2019-01-28.csv EW03-UCSF1-States-2019-01-28.csv forecast1-4wk.png ./submit")
