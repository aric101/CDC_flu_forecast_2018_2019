...
#### rename output files
system("cp ./output/all.csv ./EW11-UCSF1-2019-03-25.csv")
system("cp ./output/all.ca.csv ./EW11-UCSF1-CA-2019-03-25.csv")
system("cp ./output/all.state.csv ./EW11-UCSF1-States-2019-03-25.csv")

system("wc -l  EW11-UCSF1-2019-03-25.csv")
system("wc -l  EW11-UCSF1-CA-2019-03-25.csv")
system("wc -l  EW11-UCSF1-States-2019-03-25.csv")
system("cp  EW11-UCSF1-2019-03-25.csv EW11-UCSF1-CA-2019-03-25.csv EW11-UCSF1-States-2019-03-25.csv forecast1-4wk.png ./submit")
