...
plot.ILI <- function(){
plot(sim.test.ili[,1], type="l", main="TEST: national flu seasons 2015/2016, 2016/2018", xlab="%ILI", ylab="density", ylim=c(0,0.1))
...
plot( sim.forecast.ili[,1], type="l", main="FORECAST: national flu seasons 2018/2019", xlab="%ILI", ylab="density", ylim=c(0,0.1))
...
png(paste("./plots/Region",HHS.id,"pk.wk.forecast.png",sep=""),width=6,height=8,units="in",res=150)
...
write.csv(national4wks, paste("./output/Region",HHS.id,".pk.wk.csv",sep=""), row.names=F)
}
