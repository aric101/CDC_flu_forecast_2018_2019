...
#### rename output files
system("cp ./output/all.csv ./EW07-UCSF1-2019-02-25.csv")
system("cp ./output/all.ca.csv ./EW07-UCSF1-CA-2019-02-25.csv")
system("cp ./output/all.state.csv ./EW07-UCSF1-States-2019-02-25.csv")

system("wc -l  EW07-UCSF1-2019-02-25.csv")
system("wc -l  EW07-UCSF1-CA-2019-02-25.csv")
system("wc -l  EW07-UCSF1-States-2019-02-25.csv")
system("cp  EW07-UCSF1-2019-02-25.csv EW07-UCSF1-CA-2019-02-25.csv EW07-UCSF1-States-2019-02-25.csv forecast1-4wk.png ./submit")
