...
#### rename output files
system("cp ./output/all.csv ./EW06-UCSF1-2019-02-18.csv")
system("cp ./output/all.ca.csv ./EW06-UCSF1-CA-2019-02-18.csv")
system("cp ./output/all.state.csv ./EW06-UCSF1-States-2019-02-18.csv")

system("wc -l  EW06-UCSF1-2019-02-18.csv")
system("wc -l  EW06-UCSF1-CA-2019-02-18.csv")
system("wc -l  EW06-UCSF1-States-2019-02-18.csv")
system("cp  EW06-UCSF1-2019-02-18.csv EW06-UCSF1-CA-2019-02-18.csv EW06-UCSF1-States-2019-02-18.csv forecast1-4wk.png ./submit")
