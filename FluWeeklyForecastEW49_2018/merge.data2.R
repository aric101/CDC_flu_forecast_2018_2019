...
#### rename output files
system("cp ./output/all.csv ./EW49-UCSF1-2018-12-17.csv")
system("cp ./output/all.ca.csv ./EW49-UCSF1-CA-2018-12-17.csv")
system("cp ./output/all.state.csv ./EW49-UCSF1-States-2018-12-17.csv")


system("wc -l  EW49-UCSF1-2018-12-17.csv")
system("wc -l  EW49-UCSF1-CA-2018-12-17.csv")
system("wc -l  EW49-UCSF1-States-2018-12-17.csv")
system("cp  EW49-UCSF1-2018-12-17.csv EW49-UCSF1-CA-2018-12-17.csv EW49-UCSF1-States-2018-12-17.csv forecast1-4wk.png ./submit")
