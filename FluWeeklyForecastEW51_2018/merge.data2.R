...
#### rename output files
system("cp ./output/all.csv ./EW51-UCSF1-2018-12-31.csv")
system("cp ./output/all.ca.csv ./EW51-UCSF1-CA-2018-12-31.csv")
system("cp ./output/all.state.csv ./EW51-UCSF1-States-2018-12-31.csv")


system("wc -l  EW51-UCSF1-2018-12-31.csv")
system("wc -l  EW51-UCSF1-CA-2018-12-31.csv")
system("wc -l  EW51-UCSF1-States-2018-12-31.csv")
system("cp  EW51-UCSF1-2018-12-31.csv EW51-UCSF1-CA-2018-12-31.csv EW51-UCSF1-States-2018-12-31.csv forecast1-4wk.png ./submit")
