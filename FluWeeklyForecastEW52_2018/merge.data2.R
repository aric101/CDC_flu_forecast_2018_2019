...
#### rename output files
system("cp ./output/all.csv ./EW52-UCSF1-2019-01-07.csv")
system("cp ./output/all.ca.csv ./EW52-UCSF1-CA-2019-01-07.csv")
system("cp ./output/all.state.csv ./EW52-UCSF1-States-2019-01-07.csv")


system("wc -l  EW52-UCSF1-2019-01-07.csv")
system("wc -l  EW52-UCSF1-CA-2019-01-07.csv")
system("wc -l  EW52-UCSF1-States-2019-01-07.csv")
system("cp  EW52-UCSF1-2019-01-07.csv EW52-UCSF1-CA-2019-01-07.csv EW52-UCSF1-States-2019-01-07.csv forecast1-4wk.png ./submit")
