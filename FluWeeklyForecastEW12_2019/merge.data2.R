...
#### rename output files
system("cp ./output/all.csv ./EW12-UCSF1-2019-04-01.csv")
system("cp ./output/all.ca.csv ./EW12-UCSF1-CA-2019-04-01.csv")
system("cp ./output/all.state.csv ./EW12-UCSF1-States-2019-04-01.csv")

system("wc -l  EW12-UCSF1-2019-04-01.csv")
system("wc -l  EW12-UCSF1-CA-2019-04-01.csv")
system("wc -l  EW12-UCSF1-States-2019-04-01.csv")
system("cp  EW12-UCSF1-2019-04-01.csv EW12-UCSF1-CA-2019-04-01.csv EW12-UCSF1-States-2019-04-01.csv forecast1-4wk.png ./submit")
