...
#### rename output files
system("cp ./output/all.csv ./EW50-UCSF1-2018-12-24.csv")
system("cp ./output/all.ca.csv ./EW50-UCSF1-CA-2018-12-24.csv")
system("cp ./output/all.state.csv ./EW50-UCSF1-States-2018-12-24.csv")


system("wc -l  EW50-UCSF1-2018-12-24.csv")
system("wc -l  EW50-UCSF1-CA-2018-12-24.csv")
system("wc -l  EW50-UCSF1-States-2018-12-24.csv")
system("cp  EW50-UCSF1-2018-12-24.csv EW50-UCSF1-CA-2018-12-24.csv EW50-UCSF1-States-2018-12-24.csv forecast1-4wk.png ./submit")
