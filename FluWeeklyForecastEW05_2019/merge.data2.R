...
#### rename output files
system("cp ./output/all.csv ./EW05-UCSF1-2019-02-11.csv")
system("cp ./output/all.ca.csv ./EW05-UCSF1-CA-2019-02-11.csv")
system("cp ./output/all.state.csv ./EW05-UCSF1-States-2019-02-11.csv")

system("wc -l  EW05-UCSF1-2019-02-11.csv")
system("wc -l  EW05-UCSF1-CA-2019-02-11.csv")
system("wc -l  EW05-UCSF1-States-2019-02-11.csv")
system("cp  EW05-UCSF1-2019-02-11.csv EW05-UCSF1-CA-2019-02-11.csv EW05-UCSF1-States-2019-02-11.csv forecast1-4wk.png ./submit")
