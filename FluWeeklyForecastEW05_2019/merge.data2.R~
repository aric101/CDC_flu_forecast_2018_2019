...
#### rename output files
system("cp ./output/all.csv ./EW04-UCSF1-2019-02-04.csv")
system("cp ./output/all.ca.csv ./EW04-UCSF1-CA-2019-02-04.csv")
system("cp ./output/all.state.csv ./EW04-UCSF1-States-2019-02-04.csv")


system("wc -l  EW04-UCSF1-2019-02-04.csv")
system("wc -l  EW04-UCSF1-CA-2019-02-04.csv")
system("wc -l  EW04-UCSF1-States-2019-02-04.csv")
system("cp  EW04-UCSF1-2019-02-04.csv EW04-UCSF1-CA-2019-02-04.csv EW04-UCSF1-States-2019-02-04.csv forecast1-4wk.png ./submit")
