...
#### rename output files
system("cp ./output/all.csv ./EW43-UCSF1-2018-11-05.csv")
system("cp ./output/all.ca.csv ./EW43-UCSF1-CA-2018-11-05.csv")
system("cp ./output/all.state.csv ./EW43-UCSF1-States-2018-11-05.csv")


system("wc -l  EW43-UCSF1-2018-11-05.csv")
system("wc -l  EW43-UCSF1-CA-2018-11-05.csv")
system("wc -l  EW43-UCSF1-States-2018-11-05.csv")
system("cp  EW43-UCSF1-2018-11-05.csv EW43-UCSF1-CA-2018-11-05.csv EW43-UCSF1-States-2018-11-05.csv forecast1-4wk.png ./submit")
