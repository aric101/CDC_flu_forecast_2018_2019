...
#### rename output files
system("cp ./output/all.csv ./EW44-UCSF1-2018-11-12.csv")
system("cp ./output/all.ca.csv ./EW44-UCSF1-CA-2018-11-12.csv")
system("cp ./output/all.state.csv ./EW44-UCSF1-States-2018-11-12.csv")


system("wc -l  EW44-UCSF1-2018-11-12.csv")
system("wc -l  EW44-UCSF1-CA-2018-11-12.csv")
system("wc -l  EW44-UCSF1-States-2018-11-12.csv")
system("cp  EW44-UCSF1-2018-11-12.csv EW44-UCSF1-CA-2018-11-12.csv EW44-UCSF1-States-2018-11-12.csv forecast1-4wk.png ./submit")
