...
#### rename output files
system("cp ./output/all.csv ./EW47-UCSF1-2018-12-03.csv")
system("cp ./output/all.ca.csv ./EW47-UCSF1-CA-2018-12-03.csv")
system("cp ./output/all.state.csv ./EW47-UCSF1-States-2018-12-03.csv")


system("wc -l  EW47-UCSF1-2018-12-03.csv")
system("wc -l  EW47-UCSF1-CA-2018-12-03.csv")
system("wc -l  EW47-UCSF1-States-2018-12-03.csv")
system("cp  EW47-UCSF1-2018-12-03.csv EW47-UCSF1-CA-2018-12-03.csv EW47-UCSF1-States-2018-12-03.csv forecast1-4wk.png ./submit")
