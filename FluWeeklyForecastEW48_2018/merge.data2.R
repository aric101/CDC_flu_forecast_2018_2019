...
#### rename output files
system("cp ./output/all.csv ./EW48-UCSF1-2018-12-10.csv")
system("cp ./output/all.ca.csv ./EW48-UCSF1-CA-2018-12-10.csv")
system("cp ./output/all.state.csv ./EW48-UCSF1-States-2018-12-10.csv")


system("wc -l  EW48-UCSF1-2018-12-10.csv")
system("wc -l  EW48-UCSF1-CA-2018-12-10.csv")
system("wc -l  EW48-UCSF1-States-2018-12-10.csv")
system("cp  EW48-UCSF1-2018-12-10.csv EW48-UCSF1-CA-2018-12-10.csv EW48-UCSF1-States-2018-12-10.csv forecast1-4wk.png ./submit")
