...
png(paste("./plots/Region",HHS.id,"onset.wk.forecast.png",paste=""),width=6,height=8,units="in",res=150)
...
head(national4wks)
national4wks$Location <- paste("HHS Region ",HHS.id,sep="")
nrow(national4wks)
...
write.csv(national4wks, paste("./output/Region",HHS.id,".onset.wk.csv",sep=""), row.names=F)
