...
#### rename output files
system("cp ./output/all.csv ./EW46-UCSF1-2018-11-26.csv")
system("cp ./output/all.ca.csv ./EW46-UCSF1-CA-2018-11-26.csv")
system("cp ./output/all.state.csv ./EW46-UCSF1-States-2018-11-26.csv")


system("wc -l  EW46-UCSF1-2018-11-26.csv")
system("wc -l  EW46-UCSF1-CA-2018-11-26.csv")
system("wc -l  EW46-UCSF1-States-2018-11-26.csv")
system("cp  EW46-UCSF1-2018-11-26.csv EW46-UCSF1-CA-2018-11-26.csv EW46-UCSF1-States-2018-11-26.csv forecast1-4wk.png ./submit")
