...
###### plot results ##########
##############################
png(paste("./plots/State",HHS.id,"pk prev forecast.png",sep=""),width=6,height=8,units="in",res=150)
...
write.csv(national4wks, paste("./output/State",HHS.id,".pk.prev.csv",sep=""), row.names=F)
}
