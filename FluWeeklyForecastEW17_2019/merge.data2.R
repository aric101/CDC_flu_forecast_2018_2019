...
#### rename output files
system("cp ./output/all.csv ./EW17-UCSF1-2019-05-06.csv")
system("cp ./output/all.ca.csv ./EW17-UCSF1-CA-2019-05-06.csv")
system("cp ./output/all.state.csv ./EW17-UCSF1-States-2019-05-06.csv")

system("wc -l  EW17-UCSF1-2019-05-06.csv")
system("wc -l  EW17-UCSF1-CA-2019-05-06.csv")
system("wc -l  EW17-UCSF1-States-2019-05-06.csv")
system("cp  EW17-UCSF1-2019-05-06.csv EW17-UCSF1-CA-2019-05-06.csv EW17-UCSF1-States-2019-05-06.csv forecast1-4wk.png ./submit")
