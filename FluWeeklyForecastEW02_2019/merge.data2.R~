...
#### rename output files
system("cp ./output/all.csv ./EW01-UCSF1-2019-01-14.csv")
system("cp ./output/all.ca.csv ./EW01-UCSF1-CA-2019-01-14.csv")
system("cp ./output/all.state.csv ./EW01-UCSF1-States-2019-01-14.csv")


system("wc -l  EW01-UCSF1-2019-01-14.csv")
system("wc -l  EW01-UCSF1-CA-2019-01-14.csv")
system("wc -l  EW01-UCSF1-States-2019-01-14.csv")
system("cp  EW01-UCSF1-2019-01-14.csv EW01-UCSF1-CA-2019-01-14.csv EW01-UCSF1-States-2019-01-14.csv forecast1-4wk.png ./submit")
