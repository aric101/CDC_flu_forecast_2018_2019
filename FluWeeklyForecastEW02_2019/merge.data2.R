...
#### rename output files
system("cp ./output/all.csv ./EW02-UCSF1-2019-01-21.csv")
system("cp ./output/all.ca.csv ./EW02-UCSF1-CA-2019-01-21.csv")
system("cp ./output/all.state.csv ./EW02-UCSF1-States-2019-01-21.csv")


system("wc -l  EW02-UCSF1-2019-01-21.csv")
system("wc -l  EW02-UCSF1-CA-2019-01-21.csv")
system("wc -l  EW02-UCSF1-States-2019-01-21.csv")
system("cp  EW02-UCSF1-2019-01-21.csv EW02-UCSF1-CA-2019-01-21.csv EW02-UCSF1-States-2019-01-21.csv forecast1-4wk.png ./submit")
