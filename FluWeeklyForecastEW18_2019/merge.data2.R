...
#### rename output files
system("cp ./output/all.csv ./EW18-UCSF1-2019-05-13.csv")
system("cp ./output/all.ca.csv ./EW18-UCSF1-CA-2019-05-13.csv")
system("cp ./output/all.state.csv ./EW18-UCSF1-States-2019-05-13.csv")

system("wc -l  EW18-UCSF1-2019-05-13.csv")
system("wc -l  EW18-UCSF1-CA-2019-05-13.csv")
system("wc -l  EW18-UCSF1-States-2019-05-13.csv")
system("cp  EW18-UCSF1-2019-05-13.csv EW18-UCSF1-CA-2019-05-13.csv EW18-UCSF1-States-2019-05-13.csv forecast1-4wk.png ./submit")
