...
plot((0:130)/10, sim.forecast.ili[,1], type="l", main="FORECAST: national flu seasons 2018/2019 1-4 weeks", xlab="%ILI", ylab="density", ylim=c(0,0.1))
...
png("./plots/national 1-4 week forecast.png",width=6,height=8,units="in",res=150)
...
write.csv(national4wks, "./output/national4wks.csv", row.names=F)
...
write.csv(national4wks, "./output/national4wksSMOOTH.csv", row.names=F)
...
png("./plots/forecastNational.png")
plot((head(wkID,1)-3):(tail(wkID,1)), projection[,1], lty=2,type="l", col="grey", xlab="wk", ylab="ILI%", ylim=c(0.2,7) , main="national 1-4 wk ahead", xaxt="n")
