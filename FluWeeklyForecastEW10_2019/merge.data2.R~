...
#### rename output files
system("cp ./output/all.csv ./EW08-UCSF1-2019-03-04.csv")
system("cp ./output/all.ca.csv ./EW08-UCSF1-CA-2019-03-04.csv")
system("cp ./output/all.state.csv ./EW08-UCSF1-States-2019-03-04.csv")

system("wc -l  EW08-UCSF1-2019-03-04.csv")
system("wc -l  EW08-UCSF1-CA-2019-03-04.csv")
system("wc -l  EW08-UCSF1-States-2019-03-04.csv")
system("cp  EW08-UCSF1-2019-03-04.csv EW08-UCSF1-CA-2019-03-04.csv EW08-UCSF1-States-2019-03-04.csv forecast1-4wk.png ./submit")
