...
#### rename output files
system("cp ./output/all.csv ./EW13-UCSF1-2019-04-08.csv")
system("cp ./output/all.ca.csv ./EW13-UCSF1-CA-2019-04-08.csv")
system("cp ./output/all.state.csv ./EW13-UCSF1-States-2019-04-08.csv")

system("wc -l  EW13-UCSF1-2019-04-08.csv")
system("wc -l  EW13-UCSF1-CA-2019-04-08.csv")
system("wc -l  EW13-UCSF1-States-2019-04-08.csv")
system("cp  EW13-UCSF1-2019-04-08.csv EW13-UCSF1-CA-2019-04-08.csv EW13-UCSF1-States-2019-04-08.csv forecast1-4wk.png ./submit")
