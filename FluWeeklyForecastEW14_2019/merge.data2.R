...
#### rename output files
system("cp ./output/all.csv ./EW14-UCSF1-2019-04-15.csv")
system("cp ./output/all.ca.csv ./EW14-UCSF1-CA-2019-04-15.csv")
system("cp ./output/all.state.csv ./EW14-UCSF1-States-2019-04-15.csv")

system("wc -l  EW14-UCSF1-2019-04-15.csv")
system("wc -l  EW14-UCSF1-CA-2019-04-15.csv")
system("wc -l  EW14-UCSF1-States-2019-04-15.csv")
system("cp  EW14-UCSF1-2019-04-15.csv EW14-UCSF1-CA-2019-04-15.csv EW14-UCSF1-States-2019-04-15.csv forecast1-4wk.png ./submit")
